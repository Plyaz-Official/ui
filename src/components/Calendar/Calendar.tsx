    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === 'label'
            ? 'text-sm'
            : 'text-secondary rounded-md pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-muted-foreground [&>svg]:size-3.5',
        ...
        range_start: cn('bg-primary !rounded-l-sm', defaultClassNames.range_start),
        range_middle: cn('rounded-none', defaultClassNames.range_middle),
        range_end: cn('bg-primary !rounded-r-sm', defaultClassNames.range_end),
        today: cn(
        ...
        disabled: cn('text-secondary opacity-40', defaultClassNames.disabled),
