    ...
    <Dialog>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            This is a larger dialog with more content to demonstrate the
            responsive behavior.
          </DialogDescription>
        </DialogHeader>
...
export const UserInteraction: Story = {
  render: () => (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="outline" onClick={() => {}}>Open Dialog</Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Interactive Dialog</DialogTitle>
          <DialogDescription>
            This dialog demonstrates user interaction.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
