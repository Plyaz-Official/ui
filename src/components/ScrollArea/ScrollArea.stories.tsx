      ...
      <div className="p-4">
        ...
        {Array.from({ length: 100 }, (_, i) => (
          <div key={i} className="mb-2 text-sm">
            <strong>Item {i + 1}:</strong> This is a longer piece of content that demonstrates how the scroll area handles multiple lines of text and maintains proper spacing between items.
          </div>
        ))}
      </div>
    </ScrollArea>
