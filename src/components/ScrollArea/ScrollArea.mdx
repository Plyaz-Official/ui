...
<Meta title='Components/ScrollArea' />
...
| ----------- | ------------------------------- | ------- | ------------------------------------------------------- |
| `children`  | `ReactNode`                     | -       | The content to be displayed inside the scroll area      |
| `className` | `string`                        | -       | Additional CSS classes to apply to the scroll area      |
| `...props`  | `ScrollAreaPrimitive.RootProps` | -       | Additional props passed to the Radix UI ScrollArea root |
...
| `...props`    | `ScrollAreaPrimitive.ScrollAreaScrollbarProps` | -            | Additional props passed to the Radix UI ScrollArea scrollbar |
