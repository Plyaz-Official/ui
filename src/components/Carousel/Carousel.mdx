...
<Canvas of={CarouselStories.WithCustomControls} />

### With API

<Canvas of={CarouselStories.WithApi} />
...
<Canvas of={CarouselStories.WithDots} />

### User Interaction

<Canvas of={CarouselStories.UserInteraction} />
